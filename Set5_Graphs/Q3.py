...
def main():
    ...
    print("\nShortest Path from {} to {}: \n{}".format(start_node, end_node, bfs_shortest_path(start_node, end_node)))
    print("\nDjikstra and BFS Results same path? {}".format(
        is_fastest_also_shortest(build_fastest_path(end_node), bfs_shortest_path(start_node, end_node))))
